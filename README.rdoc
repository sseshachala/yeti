...
Install Ruby 1.9.3 
Install Git
Install ubuntu build essential package - sudo apt-get install build-essential
...
3. Inside Gemfile uncomment the following under metered_url_plugin
   gem chronic
   gem sqlite3
 
  Run bundle install

 if you get the “Could not find *gem* in any of the sources” error,
  Run bundle update
